...
const signature = 'checktx <contractAddress> <checktx>';
const description = 'Decodes checktx in calls to contracts';
const help = chalk`
The command takes an address of a deployed contract and the checktx used for the call. It retrieves the contract's ABI from Etherscan, decodes de checktx against it, and prints out information about the call that can be understood in human terms.

{red Eg:}

{blue > yolo checktx 0x818E6FECD516Ecc3849DAf6845e3EC868087B755 }
...
module.exports = {
  ...
  register: (program) => {
    program
      ...
      .action(async (contractAddress, checktx) => {
        ...
        // Extract function selector from checktx.
        const selector = checktx.slice(2, 10)
        ...
        // Decode checktx.
        const payload = `0x${checktx.slice(10, checktx.length)}`
